...
/**
 * JavaFX view providing the main interactive dispatch map.
 *
 * <p>Renders hospitals, patients, Delaunay edges, Voronoi zones and assignment lines
 * on a 2-D canvas. Supports adding/removing/dragging elements, zoom/pan, CSV import,
 * map persistence and launching {@link SimulationView}.</p>
 *
 *
...
public class MapView {
    ...
    /**
     * Builds and displays the main map window.
     *
     * <p>Initialises the canvas, wires all event handlers, builds the control panel
     * and performs an initial geometry computation followed by a first render.</p>
     */
    public void show() {
        computeGeometry();
